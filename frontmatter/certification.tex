...
\large {I am happy to certify that Mst. Shaima Ashlam Chaity, Roll Number: 200121, Registration Number: 1011879, Session: 2019-2020, has completed a thesis work that enabled \textbf{``Genetic and Molecular Perspective on Endocrine and Cardiovascular Complications in Beta-Thalassemia Patients''} under my supervision to fulfill the requirements of the thesis course. This thesis was completed for a year at the Department of Computer Science and Engineering, Pabna University of Science and Technology, Pabna-6600, Bangladesh.
